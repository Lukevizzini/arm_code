...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("pulse_min_us", default_value="1000.0"),
            DeclareLaunchArgument("pulse_max_us", default_value="2000.0"),
            DeclareLaunchArgument("gripper_command_min", default_value="-1.0"),
            DeclareLaunchArgument("gripper_command_max", default_value="1.0"),
            DeclareLaunchArgument("gripper_pulse_min_us", default_value="1000.0"),
            DeclareLaunchArgument("gripper_pulse_max_us", default_value="2000.0"),
